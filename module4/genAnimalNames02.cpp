...
// (Miscounting number of lines in the file (open the file by hand, if possible,
//and check!)
// Miscalculating array element length. the sizeof() method returns the number of
//bytes, not the number of elements.
//
// References:
